...
export function joinPath(domain, joinPath) {
...
export const isJson5 = function isJson5(json) {
...
// json schema 验证器
// YApi 存储的接口 schema（schema 编辑器、swagger 导入）均为 draft-04 语义，与 server 侧保持一致，统一用 ajv-draft-04 编译
