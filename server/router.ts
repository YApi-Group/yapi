...
const INTERFACE_CONFIG = {
  ...
  user: { prefix: '/user/', controller: userController },
  group: { prefix: '/group/', controller: groupController },
  project: { prefix: '/project/', controller: projectController },
  log: { prefix: '/log/', controller: logController },
  follow: { prefix: '/follow/', controller: followController },
  col: { prefix: '/col/', controller: interfaceColController },
  test: { prefix: '/test/', controller: testController },
  open: { prefix: '/open/', controller: openController },
  statistic: { prefix: '/statismock/', controller: statisticController },
...
const routerConfig = {
  ...
  test: [
    { action: 'testPost', path: 'post', method: 'post' },
    { action: 'testGet', path: 'get', method: 'get' },
    { action: 'testPut', path: 'put', method: 'put' },
    { action: 'testDelete', path: 'delete', method: 'del' },
    { action: 'testHead', path: 'head', method: 'head' },
    { action: 'testOptions', path: 'options', method: 'options' },
    { action: 'testPatch', path: 'patch', method: 'patch' },
    { action: 'testFilesUpload', path: 'files/upload', method: 'post' },
    { action: 'testSingleUpload', path: 'single/upload', method: 'post' },
    { action: 'testHttpCode', path: 'http/code', method: 'post' },
    { action: 'testRaw', path: 'raw', method: 'post' },
    { action: 'testResponse', path: 'response', method: 'get' },
  ],
  open: [
    ...
    { action: 'exportFullData', path: 'export-full', method: 'get' },
  ],
  statistic: [
    { method: 'get', path: 'count', action: 'getStatisCount' },
    { method: 'get', path: 'get', action: 'getMockDateList' },
    { method: 'get', path: 'get_system_status', action: 'getSystemStatus' },
    { method: 'get', path: 'group_data_statis', action: 'groupDataStatis' },
  ],
  autoSync: [
    { method: 'get', path: 'get', action: 'getSync' },
    { method: 'post', path: 'save', action: 'upSync' },
  ],
  data: [
    { method: 'get', path: 'export', action: 'exportData' },
    // ...
  ],
  advmock: [
    { method: 'get', path: 'get', action: 'getMock' },
    { method: 'post', path: 'save', action: 'upMock' },
    { method: 'post', path: 'case/save', action: 'saveCase' },
    { method: 'get', path: 'case/get', action: 'getCase' },
